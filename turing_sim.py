...
def larger_k(n=10000, k=100, p=0.01, beta=0.05, bigger_factor=10):
    ...
    while True:
        ...
        if (b.areas["B"].num_first_winners <= 1) and (
                b.areas["A"].num_first_winners <= 1):
...
def turing_erase(n=50000, k=100, p=0.01, beta=0.05, r=1.0, bigger_factor=20):
    ...
    b.update_plasticities(
        area_update_map={"A": [("B", 0.8), ("C", 0.8), ("A", 0.0)],
                         "B": [("A", 0.8), ("B", 0.8)],
                         "C": [("A", 0.8), ("C", 0.8)]},
    ...
    while True:
        ...
        print(("Num new winners in A " + str(b.areas["A"].num_first_winners)))
        if (b.areas["C"].num_first_winners <= 1) and (
                b.areas["A"].num_first_winners <= 1):
    ...
    print(("Overlap of A after proj(B) vs after proj(C) is " + str(
        A_overlap) + "\n"))
